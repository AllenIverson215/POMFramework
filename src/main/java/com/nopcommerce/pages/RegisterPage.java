...
public class RegisterPage extends BasePage {
    ...
    private By registerSuccessMsg = By.xpath("//div[@class='result']");
    private  By continueBtn = By.xpath("//a[text()='Continue']");

    public  HomePage registerNewUser(String gender, String firstName, String lastName,
                                 String day, String month, String year, String email,
        ...
        elementUtil.doSendKeys(this.companyName,company);
        elementUtil.doSendKeys(this.password,password);
        elementUtil.doSendKeys(this.confirmPassword,password);
        elementUtil.doClick(registerBtn);
        elementUtil.waitFor(2000);
        elementUtil.doClick(registerSuccessMsg);
