...
public class HomePage extends BasePage {
    ...
    //1. Capture elements by its locator - OBJ repos.
    /*
    ...
    private By button = By.xpath("//button[text()='Search']");
    ...
    //2. method that performs action on elements
    ...
    public RegisterPage goToRegisterPage(){
        //river.findElement(registerLink).click();
    ...
    public boolean verifiedLogoutLink() {
    ...
    public SearchPage doSearch(String keyword){
        elementUtil.doSendKeys(searchBox,keyword);
